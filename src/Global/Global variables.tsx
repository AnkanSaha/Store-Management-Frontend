...
export const Hostname: String = "http://store.theankan.live/api"; // Hostname ex: http://localhost:3201/api/ / https://store.theankan.live/api/
...
export const OwnerPhone: number = 9641620563; // Owner Phone Number
export const OwnerAddress: String = "Near Daluabari Bazar, Ranaghat, WB, India"; // Owner Address
export const JWT_Secret : String | any = "A1B2C3D4E5F6G7H8I9J0K1L2M3N4O5P6Q7R8S9T0U1V2W3X4Y5Z6"; // JWT Secret
