...
export const Hostname: String = "https://store.daluabari.in/api";  // / https://store.daluabari.in/api"; // Hostname ex: http://localhost:3201/api / https://store.theankan.live/api
