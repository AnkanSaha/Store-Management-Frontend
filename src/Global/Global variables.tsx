...
export const Hostname: String = "https://store.theankan.live/api";  // / https://store.theankan.live/api"; // Hostname ex: http://localhost:3201/api / https://store.theankan.live/api
