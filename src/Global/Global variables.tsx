...
export const Hostname: String = "https://store.theankan.live"; // Hostname ex: http://localhost:3201 / https://store.theankan.live
...
export const OwnerPhone: String = "+91 9641620563"; // Owner Phone Number
