              ...
              <tbody>
                {
                  ...
                  <td className="px-6 py-4">₹{Employee.EmployeeMonthlySalary}</td>
                  <td className="px-6 py-4">{Employee.EmployeeRole}</td>
                  <td className="px-6 py-4">{Employee.EmployeeDateOfJoining}</td>
