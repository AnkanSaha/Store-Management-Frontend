// Description: Signup Terms & Conditions Section component
...
import { Connection_Fail } from "../../Most Used Components/Connection Fail"; // import Connection from "./Most Used Components/Connection";
...
function Signup_Terms_and_Conditions_Section() {
  // using Context API
  const { InternetStatus }: any = useContext(GlobalContext); // destructure Context API
  // Initiate Global Functions
  Update_Document_Title({ TitleName: `Terms & Conditions for ${AppName}` }); // Update Document Title
  Internet_Connection_Status(); // Check Internet Connection Status
  ...
  return (
    <>
      ...
      <div className="mx-10 mt-[5rem]">
        <h2 className="text-4xl mb-10 ml-[19.5rem] font-extrabold dark:text-white">
          Terms & Conditions for {AppName}
        </h2>
        ...
        <p>
          ...
          use of {AppName}'s Website, located at {APPURL}.
        </p>
        ...
        <p>
          ...
          use cookies in agreement with the {AppName}'s Privacy Policy.{" "}
        </p>
        ...
        <p>
          ...
          Store Manager does not filter, edit, publish or review Comments prior
          to their presence on the website. Comments do not reflect the views
          and opinions of {AppName},its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, {AppName} shall
        ...
        <p>
          No use of {AppName}'s logo or other artwork will be allowed for
...
export default Signup_Terms_and_Conditions_Section; // export Signup Terms & Conditions Section component
